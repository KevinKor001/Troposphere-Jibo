...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/arm-linux-gnueabihf/perl/5.40',
    ...
    exe_ext => '',
    inc_version_list => '5.40.0 5.40.0/arm-linux-gnueabihf-thread-multi-64int',
    intsize => '4',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib/arm-linux-gnueabihf/perl/5.40.1',
